...
package ma.wanam.xsense.adapters;

import java.util.ArrayList;
import java.util.List;

import ma.wanam.xsense.adapters.BaseListAdapterFilter.IBaseListAdapterFilterable;
...
public class IconListAdapter extends ArrayAdapter<IIconListAdapterItem> implements
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			Typeface tf = Typeface.createFromFile(Constants.SYSTEM_FONTS_ROBOTO8CONDENCED_TTF);
			if (tf != null) {
