...
import ma.wanam.xsense.battery.BroadcastSubReceiver;
import ma.wanam.xsense.battery.StatusBarIconManager;
		...
		try {
			...
			XposedBridge.hookAllConstructors(phoneStatusbarViewClass, new XC_MethodHook() {
				...
				protected void afterHookedMethod(final MethodHookParam param) throws Throwable {
					...
					Context gbContext = mPanelBar.getContext().createPackageContext(Packages.XSense,
